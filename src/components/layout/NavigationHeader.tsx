...
export function NavigationHeader({ title }: NavigationHeaderProps) {
  ...
  return (
    <div ref={headerRef} className="bg-gradient-to-r from-[hsl(var(--gradient-start))]/30 to-[hsl(var(--gradient-end))]/30 border-b border-[hsl(var(--card-accent))]/20 sticky z-10 backdrop-blur-sm" style={{ top: 0 }}>
